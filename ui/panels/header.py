...
def build_header(dashboard) -> PaintedHeaderBar:
    ...
    dashboard._midi_dot.setAccessibleName("Trạng thái MIDI")
    dashboard._midi_dot.setAccessibleDescription("Chỉ báo kết nối MIDI tới Studio One. Nhấn F2 để nghe trạng thái.")
    ...
    dashboard._browser_dot.setAccessibleName("Trạng thái trình duyệt")
    dashboard._browser_dot.setAccessibleDescription("Chỉ báo đồng bộ với trình duyệt YouTube.")
    ...
    dashboard._marquee_widget.setAccessibleName("Thông báo")
    dashboard._marquee_widget.setAccessibleDescription("Vùng hiển thị thông báo cuộn của ứng dụng.")
    ...
    dashboard.autokey_dot.setAccessibleName("Đèn AutoKey")
    dashboard.autokey_dot.setAccessibleDescription("Sáng khi đang dò tone tự động.")
    ...
    dashboard.tone_combo.setAccessibleName("Tone gốc")
    dashboard.tone_combo.setAccessibleDescription("Chọn tone gốc của bài hát: C, C#, D, D#, E, F, F#, G, G#, A, A#, B.")
    ...
    dashboard.scale_combo.setAccessibleName("Loại scale")
    ...
    dashboard._settings_btn.setAccessibleName("Cài đặt")
    dashboard._settings_btn.setAccessibleDescription("Mở hộp thoại cài đặt. Phím tắt Ctrl+Phẩy.")
    ...
    dashboard._eye_btn.setAccessibleDescription("Bật tắt cửa sổ Studio One và plugin.")
