"""Script thủ công: đóng mọi cửa sổ/process YouTube (PWA + browser window).

CẢNH BÁO: script này terminate process trình duyệt thật trên máy —
chỉ chạy trực tiếp khi cần test thủ công, KHÔNG import.
"""
